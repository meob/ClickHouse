...
{
    LOG_TRACE(log, "{}Datatype: {}, kind: {}, strictness: {}, right header: {}", instance_log_id, data->type, kind, strictness, right_sample_block.dumpStructure());
    LOG_TRACE(log, "{}Keys: {}", instance_log_id, TableJoin::formatClauses(table_join->getClauses(), true));
